...
export const BRANCHES: { label: string; address: string }[] = [
  { label: 'Bílina',                        address: 'Petra Bezruče 1/1, 418 01 Bílina'                              },
  { label: 'Brno – Londýnské nám.',         address: 'Londýnské nám. 853/1, 639 00 Brno'                             },
  { label: 'Brno – Palackého (CC)',         address: 'Palackého třída 1644/8, 612 00 Brno'                           },
  { label: 'České Budějovice',              address: 'Pražská tř. 1813/3, 370 01 České Budějovice'                   },
  { label: 'Chomutov – Palackého',          address: 'Palackého 3395, 430 04 Chomutov'                               },
  { label: 'Chomutov – Pražská',            address: 'Pražská 5382, 430 01 Chomutov'                                 },
  ...
  { label: 'Most – Jaroslava Průchy',       address: 'Jaroslava Průchy 1682/1, 434 01 Most'                          },
  { label: 'Most – Bankovní',               address: 'Bankovní 1300, 434 01 Most'                                    },
  { label: 'Nový Jičín',                    address: 'Štefánikova 2086/12, 741 01 Nový Jičín'                        },
  { label: 'Olomouc',                       address: 'Riegrova, 779 00 Olomouc'                                      },
  ...
  { label: 'Praha – Jindřišská 889/17',     address: 'Jindřišská 889/17, 110 00 Praha 1'                             },
  { label: 'Praha – Jindřišská 16',         address: 'Jindřišská 16, 110 00 Praha 1'                                 },
  { label: 'Přerov',                        address: 'Lipnická 535/1, 750 02 Přerov'                                 },
  { label: 'Rožnov pod Radhoštěm',         address: 'Bučiska 621, 756 61 Rožnov pod Radhoštěm'                      },
  { label: 'SHOWROOM Vestec',               address: 'Vídeňská 400, 252 42 Vestec'                                   },
